...
#define llsym(_type, _name, _list)                                             \
	((_type *)&_rock_list_2_##_list##_2_##_name)
...
#define ll_entry_declare(_type, _name, _list)                                  \
	_type _rock_list_2_##_list##_2_##_name __aligned(4) __attribute__(   \
		(unused, section(".rock_list_2_" #_list "_2_" #_name)))
 ...
 * linker-generated array placed into subsection of .rock_list section
...
#define ll_entry_start(_type, _list)                                           \
	({                                                                     \
		static char start[0] __aligned(4) __attribute__(               \
			(unused, section(".rock_list_2_" #_list "_1")));     \
		(_type *)&start;                                               \
	})
 ...
 * a linker-generated array placed into subsection of .rock_list
...
#define ll_entry_end(_type, _list)                                             \
	({                                                                     \
		static char end[0] __aligned(4) __attribute__(                 \
			(unused, section(".rock_list_2_" #_list "_3")));     \
		(_type *)&end;                                                 \
	})
/**
 ...
 * placed into subsection of .rock_list section specified by _list
 ...
 * array identified by the subsection of rock_list where the entry resides
 * and it's name.
 *
 * Example:
 *
...
#define ll_entry_get(_type, _name, _list)                                      \
	({                                                                     \
		extern _type _rock_list_2_##_list##_2_##_name;               \
		_type *_ll_result = &_rock_list_2_##_list##_2_##_name;       \
		_ll_result;                                                    \
	})
...
#define ll_start(_type)                                                        \
	({                                                                     \
		static char start[0] __aligned(4)                              \
			__attribute__((unused, section(".rock_list_1")));    \
		(_type *)&start;                                               \
	})
...
#define ll_end(_type)                                                          \
	({                                                                     \
		static char end[0] __aligned(4)                                \
			__attribute__((unused, section(".rock_list_3")));    \
		(_type *)&end;                                                 \
	})
